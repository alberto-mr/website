---
layout: page
title: Discovering Trigger-Action Rules
permalink: /eud-discovery/
---
<img style="float: right; margin-left: 10px; " height="250px"  src="../assets/images/PC_rule_recommendations.png">
<p style='text-align: justify;'>
We also explored how to use the <a href ="../eud">EUPont model</a> to help users discover proper "low-level" triggers, actions, and rules without requiring any radical change in the adopted representation model. To overcome the information overload issue that characterize contemporary platforms like IFTTT and Zapier, in particular, we explored different approaches and techniques, ranging from optimisation methods and recommendation algorithms to conversational methods. The following are the main outcomes of such an exploration.
<dl style='text-align: justify;'>
  ...
  <br><br>
  The RecRules algorithm is hosted on this <a href="https://git.elite.polito.it/public-projects/recrules">repository</a>.
  </dd>
  <dt><b>TAPrec</b></dt>
  <dd>
  ...
  <br><br>
  The HeyTAP<sup>2</sup> algorithm is hosted in this <a href = "https://git.elite.polito.it/public-projects/intrec">repository</a>. HeyTAP<sup>2</sup> was presented at <a href="https://sigir.org/sigir2022">SIGIR 2022</a>:

  <p><iframe style="display: block; margin-top:10px; margin-left: auto; margin-right: auto;"  width="560" height="315" src="https://www.youtube.com/embed/C-LcCSGRHzg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></p>
  </dd>
</dl>
